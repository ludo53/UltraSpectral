// src/lib.rs
/*
 * Core library for UltraSpectral
 */
...
#[derive(Debug)]
pub struct UltraSpectralProcessor {
    verbose: bool,
    processed_count: usize,
}

impl UltraSpectralProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting UltraSpectral processing");
    
    let mut processor = UltraSpectralProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = UltraSpectralProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = UltraSpectralProcessor::new(false);
